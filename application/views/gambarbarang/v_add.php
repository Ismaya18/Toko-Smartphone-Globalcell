    ...
    <div class="card card-primary">
        <div class="card-header">
            ...
            echo form_open_multipart('gambarbarang/add/' . $barang->id_barang) ?>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                        <img src="<?= base_url('assets/gambar/insert.png') ?>" id="gambar_load" width="200px">
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <?php foreach ($gambar as $key => $value) { ?>
                <div class="col-sm-3">
                    <div class="form-group">
                        <img src="<?= base_url('assets/gambarbarang/' . $value->gambar) ?>" id="gambar_load" width="250px" height="175px">
                    </div>
