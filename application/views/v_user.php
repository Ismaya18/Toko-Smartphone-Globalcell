  ...
  <div class="card card-primary">
    <div class="card-header">
      ...
      <div class="card-tools">
        <button data-toggle="modal" data-target="#add" type="button" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i>Tambah
        </button>
      </div>
      <!-- /.card-tools -->
    </div>
            ...
            <tr>
              ...
              <td class="text-center"><?php
                                      if ($value->level_user == 1) {
                                        ...
                                        echo '<span class="badge bg-success">Admin2</span>';
                                      }
                                      ?></td>
...
<?php foreach ($user as $key => $value) { ?>
  <div class="modal fade" id="delete<?= $value->id_admin ?>">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Hapus <?= $value->nama_admin ?></h4>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        ...
        <div class="modal-footer justify-content-between">
          <button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
          <a href="<?= base_url('user/delete/' . $value->id_admin) ?>" class="btn btn-primary">Hapus</a>
        </div>
      </div>
      <!-- /.modal-content -->
    </div>
