  ...
  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="<?= base_url('assets/slider/slider1.jpg') ?>" class="d-block w-100" height="225"alt="...">
      </div>
      <div class="carousel-item">
        <img src="<?= base_url('assets/slider/slider2.jpg') ?>" class="d-block w-100" height="225" alt="...">
      </div>
      <div class="carousel-item">
        <img src="<?= base_url('assets/slider/slider3.jpg') ?>" class="d-block w-100" height="225" alt="...">
      </div>
      <div class="carousel-item">
        <img src="<?= base_url('assets/slider/slider4.jpg') ?>" class="d-block w-100" height="225" alt="...">
      </div>
    </div>
