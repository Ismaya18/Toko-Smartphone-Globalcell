                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($value->status_bayar == 1) { ?>
                                        <button class="btn btn-xs btn-success btn-flat" data-toggle="modal" data-target="#cek<?= $value->id_transaksi ?>">Cek Bukti Bayar</button>
                                        <a href="<?= base_url('admin/proses/' . $value->id_transaksi) ?>" class="btn btn-xs btn-flat btn-primary">Proses</a>
                                    <?php } ?>
                                </td>
                            </tr>
                        <?php } ?>
